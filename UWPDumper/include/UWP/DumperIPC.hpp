...
// String messaging
IPC_API void PushMessage(ErrorStatus es, float Progress, const wchar_t* Format, ...);
IPC_API void PushMessage(const wchar_t* Format, ...);
IPC_API bool PopMessage(std::wstring& Output, ErrorStatus &Error, float &Progress);
